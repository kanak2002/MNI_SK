...
- third_party: the service or company involved. Use these exact names where applicable:
  flights: "Google Flights", "Delta", "Kayak"
  hotels: "Marriott", "Hilton", "Hotels.com"
  payments: "Stripe", "Chase"
  calendar: "Google Calendar"
  shopping: "Amazon"
  If unsure, use the most specific known service name in Title Case.
